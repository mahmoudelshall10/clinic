        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    {!!Form::open(["url"=>"admin/items","method"=>"POST","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldTitleAR" data-required="1" required="required" class="form-control" value="{{ old('fldTitleAR') }}"  /> 
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldTitleEN" data-required="1" required="required" class="form-control" value="{{ old('fldTitleEN') }}"  /> 
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select  name="fldType" data-required="1" required="required" class="form-control" >
                                                ...
                                                <option value="Incomes">{{ trans('finance.incomes')}}</option>
                                                <option value="Outcomes">{{ trans('finance.outcomes')}}</option>
                                            </select> 
                                        </div>
                                    </div> 
