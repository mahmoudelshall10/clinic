        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    {!!Form::open(["url"=>"admin/hr_loans_payments/create/$objLoanPayment->pkLoanPaymentID","method"=>"PATCH","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="number" min="1" max="{{$objLoan->fldAmount}}" name="fldAmount" data-required="1" required="required" class="form-control" value="{{ $objLoanPayment->fldAmount }}"  /> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" name="fldDate" data-required="1" required="required" class="form-control" value="{{ $objLoanPayment->fldDate  }}"/>
                                    </div>
                                </div>
                            </div>
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                      ...
                                      <a href="{{ url('admin/hr_loans_payments/create/' . $objLoan->pkLoanID) }}" class="btn grey-salsa btn-outline">Back</a>
                                    </div>
                                </div>
                            </div>
                    {!! Form::close() !!}
