            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                        ...
                        <tbody>
                            @foreach( $arrPaymentsLoans as $objLoanPayment )
                                <tr>
                                    <td> {{ $objLoanPayment->HrLoan->Admin->Job->Department->fldNameAR }} </td>
                                    <td> {{ $objLoanPayment->HrLoan->Admin->Job->fldNameAR }} </td>
                                    <td> {{ $objLoanPayment->HrLoan->Admin->name }} </td>
                                    <td> {{ $objLoanPayment->HrLoan->fldAmount }} </td>
                                    <td> {{ $objLoanPayment->fldAmount }} </td>
                                    <td> {{ $objLoanPayment->fldDate }} </td>
                                    <td><span data-class="pencil-square-o"><a href="{{ url('admin/hr_loans_payments/create/'. $objLoanPayment->pkLoanPaymentID.'/edit') }}"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                    </span>
                                    </td>
                                    <td> 
                                        {!!Form::open(["url"=>"admin/hr_loans_payments/create/$objLoanPayment->pkLoanPaymentID","method"=>"DELETE","onclick"=>"return confirm('Are U Sure To Delete !!')"])!!}                
