...
@section('content')
    ...
    <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> 
        <a href="{{ url('admin/hr_loans/search_preview') }}" class="btn btn-success">New Search Staff Loan</a>
                            ...
                            <tbody>
                                @foreach( $arrLoans as $objLoan )
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="{{ url('admin/hr_loans_payments/create', $objLoan->pkLoanID) }}">Refund
                                        </td>
