        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    {!!Form::open(["url"=>"admin/hr_loans","method"=>"POST","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="fldAmount" data-required="1" required="required" class="form-control" value="{{ old('fldAmount') }}"  /> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select name="fldStatus" class="form-control" required data-required="1" value="{{ old('fldStatus')}}">
                                            <option value="{{$objLoan::UNPAID}}">Unpaid</option>
                                            <option value="{{$objLoan::PAID}}">Paid</option>
                                        </select>
                                    </div>
                                </div>
...
$.ajax({
    type: "GET",
    url: "{{url('admin/staff/getloanstaffs')}}"+"/"+fkJobID,
    success: function (res) {
        
        $("#fkStaffID").empty();
        $("#fkStaffID").append('<option value="">Select Staff...</option>');
