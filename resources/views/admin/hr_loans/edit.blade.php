        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    {!!Form::open(["url"=>"admin/hr_loans/$objLoan->pkLoanID","method"=>"PATCH","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                <select  class="form-control" name="fkDepartmentID" id="fkDepartmentID" required data-required="1">
                                                    ...
                                                    @foreach( $arrDepartments as $objDepartment )
                                                        <option {{ $objLoan ->Admin->fkDepartmentID ==  $objDepartment->pkDepartmentID   ? 'selected' : ''  }} value="{{ $objDepartment->pkDepartmentID }}" > {{ $objDepartment->fldNameAR }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    </div>                                   
                                        ...
                                        <div class="col-md-4">
                                            <select  class="form-control" name="fkJobID" id="fkJobID" required data-required="1">
                                                ...
                                                @foreach( $arrJobs as $objJob )
                                                    <option {{ $objLoan->Admin->fkJobID ==  $objJob->pkJobID   ? 'selected' : ''  }} value="{{ $objJob->pkJobID }}" > {{ $objJob->fldNameAR }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                    ...
                                                    @foreach( $arrStaffs as $objStaff )
                                                        <option {{ $objLoan->fkStaffID ==  $objStaff->id   ? 'selected' : ''  }} value="{{ $objStaff->id }}" > {{ $objStaff->name }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldAmount" data-required="1" required="required" class="form-control" value="{{ $objLoan->fldAmount }}"  /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <select name="fldStatus" id="fldStatus" class="form-control" required data-required="1" >
                                                {{-- <option value="">Select Status</option> --}}
                                                <option value="{{$objLoan::PAID}}" {{$objLoan->fldStatus == $objLoan::PAID ? 'selected' : ''}} >
                                                    Paid
                                                </option>
                                                
                                                <option value="{{$objLoan::UNPAID}}" {{$objLoan->fldStatus == $objLoan::UNPAID ? 'selected' : ''}}  >
                                                    Unpaid
                                                </option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                                <input type="date" name="fldDate" data-required="1" required="required" class="form-control" value="{{ $objLoan->fldDate }}"  /> 
                                        </div>
                                    </div>      
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                      ...
                                      <a href="{{ route('hr_loans.index') }}" class="btn grey-salsa btn-outline">Back</a>
                                    </div>
                                </div>
                            </div>
                    {!! Form::close() !!}
