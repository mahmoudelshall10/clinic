                            ...
                            <tbody>
                                @foreach( $arrAdmins as $objAdmin )
                                    <tr>
                                        ...
                                        <td>
                                            <span data-class="pencil-square-o"><a href="{{ route('admins.edit', $objAdmin->id) }}"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
                                            </span>
                                        </td>
                                        <td>
                                            {!!Form::open(["url"=>"admin/admins/$objAdmin->id","method"=>"DELETE","onclick"=>"return confirm('Are U Sure To Delete !!')"])!!}                
