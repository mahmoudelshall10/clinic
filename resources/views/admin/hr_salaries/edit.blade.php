        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    {!!Form::open(["url"=>"admin/hr_salaries/$objSalary->pkSalaryID","method"=>"PATCH","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                            ...
                                            <div class="col-md-4">
                                                <select  class="form-control" name="fkDepartmentID" id="fkDepartmentID" required data-required="1">
                                                    ...
                                                    @foreach( $arrDepartments as $objDepartment )
                                                        <option {{ $objSalary->Admin->fkDepartmentID ==  $objDepartment->pkDepartmentID   ? 'selected' : ''  }} value="{{ $objDepartment->pkDepartmentID }}" > {{ $objDepartment->fldNameAR }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    </div>                                   
                                        ...
                                        <div class="col-md-4">
                                            <select  class="form-control" name="fkJobID" id="fkJobID" required data-required="1">
                                                ...
                                                @foreach( $arrJobs as $objJob )
                                                    <option {{ $objSalary->Admin->fkJobID ==  $objJob->pkJobID   ? 'selected' : ''  }} value="{{ $objJob->pkJobID }}" > {{ $objJob->fldNameAR }} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                    ...
                                                    @foreach( $arrAdmins as $objAdmin )
                                                        <option {{ $objSalary->fkStaffID ==  $objAdmin->id   ? 'selected' : ''  }} value="{{ $objAdmin->id }}" > {{ $objAdmin->name }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="Salary" data-required="1" required="required" class="form-control" value="{{ $objSalary->Salary }}"  /> 
                                        </div>
                                    </div> 
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                                <input type="date" name="Start_Date"  class="form-control" value="{{ $objSalary->Start_Date }}"  /> 
                                        </div>
                                    </div>     
