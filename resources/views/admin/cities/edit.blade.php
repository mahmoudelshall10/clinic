        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    {!!Form::open(["url"=>"admin/cities/$objCity->pkCityID","method"=>"PATCH","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" name="fkCountryID" id='fkCountryID' required  data-required="1">
                                      ...
                                      @foreach( $arrCountries as $objCountry )
                                        <option {{ $objCity->Area->fkCountryID ==  $objCountry->pkCountryID   ? 'selected' : ''  }} value="{{ $objCountry->pkCountryID }}">{{ $objCountry->fldNameEN }} </option>
                                      @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="fkAreaID" id='fkAreaID' required="required" data-required="1">
                                            ...
                                            @foreach( $arrAreas as $objArea )
                                                <option {{ $objCity->fkAreaID ==  $objArea->pkAreaID   ? 'selected' : ''  }} value="{{ $objArea->pkAreaID }}">{{ $objArea->fldNameEN }} </option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldNameEN"  required="required" data-required="1" class="form-control" value="{{ $objCity->fldNameEN }}" /> </div>
                                    </div>
                                ...
                                <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" name="fldNameAR"  required="required" data-required="1" class="form-control" value="{{ $objCity->fldNameAR }}" /> </div>
                                    </div>
