        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    {!!Form::open(["url"=>"admin/reservations/$objReservation->pkReservationID","method"=>"PATCH","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                    ...
                                    <div class="col-md-9">
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" name="fldPhone" id="fldPhone" data-required="1" required="required" class="form-control" value="{{ $objReservation->Patients->fldPhone1 }}"  /> 
                                                        <input type="hidden" name="fkPatientID" id="fkPatientID"  class="form-control" value="{{$objReservation->fkPatientID}}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select  name="fkDoctorID" id="fkDoctorID" data-required="1" required="required" class="form-control" >
                                                        ...
                                                        @if($objReservation->fkDoctorID==$objStaff->id)
                                                        <option selected value="{{ $objStaff->id}}">{{ $objStaff->name}}</option>
                                                        @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="date" name="fldDate"  id="fldDate" data-required="1" required="required" class="form-control" value="{{$objReservation->fldDate}}"  /> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <textarea  name="fldNotes"  class="form-control">{{$objReservation->fldNotes}}</textarea> 
                                                    </div>
                                            </div>
