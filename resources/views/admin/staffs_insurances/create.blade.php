        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    {!!Form::open(["url"=>"admin/staffs_insurances","method"=>"POST","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">       
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                                <select  class="form-control" name="fkInsuranceID" id="fkInsuranceID" >
                                                <option value="">Select Insurance...</option>
                                                    @foreach ($arrInsurances as $objInsurance)
                                                        <option value="{{ $objInsurance->pkInsuranceID }}" > {{ $objInsurance->Start_Date }} - {{ $objInsurance->End_Date }} </option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-3"> Fix Amount
                                            <span class="required"> * </span>
                                        </label>
                                        <div class="col-md-4 span-color">
                                                <span id="textfixAmount">Rules</span>
                                                <input id="fldMinFixAmount" type="number" name="fldMinFixAmount" min="100" max="400"  data-required="1" class="form-control" required="required" value="{{ old('fldMinFixAmount') }}"  />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 span-color">
                                            ...
                                            <input id="fldMaxVarAmount" type="number" name="fldMaxVarAmount"  min="100" max="400" data-required="1" class="form-control" required="required" value="{{ old('fldMaxVarAmount') }}"  />
                                        </div>
                                    </div>
