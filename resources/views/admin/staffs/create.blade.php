        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    {!!Form::open(["url"=>"admin/staff" ,"method"=>"POST","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-4">
                                  ...
                                  @foreach( $arrBranches as $objBranch )
                                    <option value="{{ $objBranch->pkBranchID }}">{{ $objBranch->fldNameAR }} </option>
                                   @endforeach
                                 </select>
                               </div>
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="fldNameAR" data-required="1" class="form-control" required="required" value="{{ old('fldNameAR') }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="name" data-required="1" class="form-control" required="required" value="{{ old('name') }}" />
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="fldPhone1" data-required="1" class="form-control" required="required" value="{{ old('fldPhone1') }}" />
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="fldAddressAR" data-required="1" class="form-control" required="required" value="{{ old('fldAddressAR') }}" />
                                    </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="fldAddressEN" data-required="1" class="form-control" required="required" value="{{ old('fldAddressEN') }}" />
                                    </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="fldDegree" data-required="1" class="form-control"  value="{{ old('fldDegree') }}" />
                                    </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="date" name="fldDateOfBirth" data-required="1" class="form-control" required="required" value="{{ old('fldDateOfBirth') }}" />
                                    </div>
                            </div>
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                            <select name="fldGender" class="form-control" required data-required="1" value="{{ old('fldGender')}}">
                                                <option value="{{$objadmin::GENDER_MALE}}">ذكر</option>
                                                <option value="{{$objadmin::GENDER_FEMALE}}">انثي</option>
                                            </select>
                                        </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="email" data-required="1" class="form-control" required="required" value="{{ old('email') }}"  />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">Repeat Password
                                    <span class="required"> * </span>
                                </label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="file" required="required" name="file"  id="exampleInputFile">
                                </div> 
                            </div>
                        </div>
