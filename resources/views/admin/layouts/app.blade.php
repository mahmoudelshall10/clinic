...
<html lang="en"> 
    ...
    <head>
        <meta charset="utf-8" />
        <title>{{$objSetting->fldSiteNameEN}} | @yield('strTitle')</title>
        ...
        @include('admin.includes.plugin_language_js')
        <link href="{{ asset('assets/global/plugins/fullcalendar/fullcalendar.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img style="    width: 50px;background-color: white;" src="{{url('storage/app')}}/{{ $objSetting->fldPhoto }}" alt="logo" class="logo-default" /> </a>
        ...
        <div class="page-container">
            ...
            @else
                @include('admin.layouts.sidebar_user')
            @endif
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2018 &copy; Souq Sidra by Mahmoud ALi.
                <a href="http://mahmoud-mohamed.com" title="" target="_blank">Mahmoud Ali!</a>
            </div>
...
<![endif]-->
        ...
        @if(Request::segment(2) == '')
        <!-- BEGIN PAGE LEVEL SCRIPTS FOR DASHBOARD-->
        <script src="{{ asset('assets/pages/scripts/dashboard.min.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS FOR DASHBOARD-->
        @endif
        ...
        @if(Request::segment(3) == '' &&  Request::segment(2) != 'reservationspayment')
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
