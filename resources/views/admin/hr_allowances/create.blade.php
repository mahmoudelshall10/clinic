        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    {!!Form::open(["url"=>"admin/hr_allowances","method"=>"POST","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="Allowance" data-required="1" required="required" class="form-control" value="{{ old('Allowance') }}"  /> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                                <select name="fldType"  id="fldType" class="form-control" required data-required="1" value="{{ old('fldType')}}">
                                                    <option value="{{$objAllowance::TYPE_FIXED}}">fixed</option>
                                                    <option value="{{$objAllowance::TYPE_VARIABLE}}">variable</option>
                                                </select>
                                            </div>
                                    </div>
