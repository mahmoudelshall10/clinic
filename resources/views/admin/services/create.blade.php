        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    ...
                    {!!Form::open(["url"=>"admin/services","method"=>"POST","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldServiceNameAR" data-required="1" required="required" class="form-control" value="{{ old('fldServiceNameAR') }}"  /> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldServiceNameEN" data-required="1" required="required" class="form-control" value="{{ old('fldServiceNameEN') }}"  /> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="fldPrice" data-required="1" required="required" class="form-control" value="{{ old('fldPrice') }}"  /> 
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="number" name="fldTax" data-required="1" required="required" class="form-control" value="{{ old('fldTax') }}"  /> 
                                        </div>
                                    </div>
                                    <div class="form-group">
