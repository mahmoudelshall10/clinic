        ...
        <div class="col-md-12">
            ...
            <div class="portlet light portlet-fit portlet-form bordered">
                ...
                <div class="portlet-body">
                    <!-- BEGIN FORM-->
                    {!!Form::open(["url"=>"admin/hr_deductions/$objDeduction->pkDeductionID","method"=>"PATCH","id"=>"form_sample_3","class"=>"form-horizontal","files"=>"true"])!!}
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            @foreach( $arrDepartments as $objDepartment )
                                                 <option {{ $objDeduction->Admin->Job->Department->pkDepartmentID ==  $objDepartment->pkDepartmentID   ? 'selected' : ''  }} value="{{ $objDepartment->pkDepartmentID }}">{{ $objDepartment->fldNameAR }} </option>
                                            @endforeach
                                            </select>
                                        </div>
                                </div>
                                <div class="form-group">
                                  ...
                                  <div class="col-md-4">
                                       <select class="form-control" data-required="1" name="fkJobID" id="job_id" required="required" >
                                        ...
                                        <option {{ $objDeduction->Admin->Job->pkJobID ==  $objectjob->pkJobID   ? 'selected' : ''  }} value="{{ $objectjob->pkJobID }}">{{ $objectjob->fldNameAR }} </option>
                                   @endforeach
                                     </select>
                                   </div>
                                </div>
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                    ...
                                                    @foreach( $arrAdmins as $objAdmin )
                                                        <option {{ $objDeduction->fkStaffID ==  $objAdmin->id   ? 'selected' : ''  }} value="{{ $objAdmin->id }}" > {{ $objAdmin->fldNameAR }} </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" name="fldTheAmount" data-required="1" required="required" class="form-control" value="{{ $objDeduction->fldTheAmount }}"  /> 
                                        </div>
                                    </div>  
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                                <input type="date" name="fldHistory" data-required="1" required="required" class="form-control" value="{{ $objDeduction->fldHistory }}"  /> 
                                        </div>
                                    </div>     
         ...
         if (pkDepartmentID) {
            ...
            success: function (res) {
                ...
                $("#job_id").append('<option>Select Job...</option>');
                    ...
                    console.log(value);
                    $("#job_id").append('<option value="' + value.pkJobID + '">' + value.fldName + '</option>');
                });
            }
            });
        } else {
