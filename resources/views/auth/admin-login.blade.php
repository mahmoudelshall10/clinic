...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
    <title> {{$objSetting->fldSiteNameEN}}| Admin Login </title>
    ...
    <body class=" login" style="background-color: #a6b3c5!important;">
        <!-- BEGIN LOGO -->
        <div class="logo">
            <a href="index.html">
                
            <img style="    width: 100px;height: 100px;" src="{{url('storage/app')}}/{{ $objSetting->fldPhoto }}" alt="logo" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        ...
        <div class="copyright"> {{date('Y')}} © {{$objSetting->fldSiteNameEN}}. Admin Dashboard  </div>
        <!--[if lt IE 9]>
